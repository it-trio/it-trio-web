export const SITE_TITLE = "ITトリオの日常";
export const SITE_DESCRIPTION = "ITトリオの日常の公式サイトです。";

export const RSS_FEED_URL = "https://rss.art19.com/it-pitpa";
export const SPOTIFY_SHOW_LINK =
  "https://open.spotify.com/show/4swQbE6pLzOz3p1Z9Etkqc";
...
export const YOUTUBE_MUSIC_SHOW_LINK ="https://music.youtube.com/playlist?list=PLqtv1UJuRQssCX_himpcWZLalPSeHIcR3&si=7FplzKGZJZp2Gci2"
